...
description: Review code changes with Security Review subagent before push or PR. Use when running /review-security or when touching lib, supabase, auth, or platform paths.
---
# Review Security
